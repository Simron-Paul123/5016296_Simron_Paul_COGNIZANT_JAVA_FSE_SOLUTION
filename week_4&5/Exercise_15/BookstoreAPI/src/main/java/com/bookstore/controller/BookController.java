...
public class BookController {
	...
	@Operation(summary = "Get books by Author and Title", description = "Retrieve books by Author and Title")
	@GetMapping("/search")
	...
	@Operation(summary = "Get books by ID", description = "Retrieve books by ID")
	@GetMapping("/{id}")
